...
#ifndef __DEVICE_BATTERYPASSIVE_HPP__
#define __DEVICE_BATTERYPASSIVE_HPP__
...
class BatteryPassive: public Passive
{
	// State
	...
	public:
		BatteryPassive(int id);
		virtual ~BatteryPassive();
