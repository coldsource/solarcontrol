...
#ifndef __DEVICE_ONOFF_HPP__
#define __DEVICE_ONOFF_HPP__
...
class OnOff: public Electrical
{
	...
	public:
		...
		static bool CompareTo(std::shared_ptr<OnOff> a, std::shared_ptr<OnOff> b) // OnOff devices are sorted by prio
		{
