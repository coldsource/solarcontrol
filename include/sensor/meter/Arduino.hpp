...
#ifndef __SENSOR_METER_ARDUINO_HPP__
#define __SENSOR_METER_ARDUINO_HPP__
...
class Arduino: public Meter, public mqtt::Subscriber
{
	protected:
		// Config
		std::string topic;
	...
	public:
		Arduino(const std::string &mqtt_id);
		virtual ~Arduino();
